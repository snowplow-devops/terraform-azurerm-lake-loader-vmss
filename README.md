...
| <a name="input_app_version"></a> [app\_version](#input\_app\_version) | Lake Loader app version to use. This variable facilitates dev flow, the modules may not work with anything other than the default value. | `string` | `"0.1.2"` | no |
