...
resource "azuread_application_password" "app_pasword" {
...
resource "azurerm_role_assignment" "sc_app_ra" {
...
locals {
  ...
  user_data = templatefile("${path.module}/templates/user-data.sh.tmpl", {
    ...
    client_secret = azuread_application_password.app_pasword.value

    config      = local.config
    iglu_config = local.iglu_config
